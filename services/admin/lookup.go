...
// 		response.Errors = append(response.Errors, mdlShared.NewResponseError(shared.ErrorInsertingRecord, "CreateLookup processing definitions", err.Error()))
...
// 	if err != nil {
// 		response.Code = http.StatusInternalServerError
// 		response.Errors = append(response.Errors, mdlShared.NewResponseError(shared.ErrorInsertingRecord, "CreateLookup", err.Error()))
...
// func LoadAllLookups(r *http.Request) *mdlShared.Response {
...
// 		if err != nil {
// 			response.Code = http.StatusInternalServerError
// 			response.Errors = append(response.Errors, mdlShared.NewResponseError(shared.ErrorLoadingData, "LoadLookup ParseDefinition", err.Error()))
...
// 	if err != nil {
// 		response.Code = http.StatusInternalServerError
// 		response.Errors = append(response.Errors, mdlShared.NewResponseError(shared.ErrorLoadingData, "LoadLookup", err.Error()))
...
// func UpdateLookup(r *http.Request) *mdlShared.Response {
// 	lookupCode := chi.URLParam(r, "lookup_code")
// 	lookupIDColumn := fmt.Sprintf("%s.code", shared.TableCoreLookups)
// 	condition := builder.Equal(lookupIDColumn, lookupCode)
// 	lookup := models.Lookup{}
...
// func DeleteLookup(r *http.Request) *mdlShared.Response {
...
// func AddLookupOption(r *http.Request) *mdlShared.Response {
...
// 		if err != nil {
// 			response.Code = http.StatusInternalServerError
// 			response.Errors = append(response.Errors, mdlShared.NewResponseError(shared.ErrorInsertingRecord, "AddLookupOption checking if code already exists", err.Error()))
...
// 	if total > 0 {
// 		response.Code = http.StatusInternalServerError
// 		response.Errors = append(response.Errors, mdlShared.NewResponseError(shared.ErrorInsertingRecord, "AddLookupOption", "code already exists"))
...
// 	if err != nil {
// 		response.Code = http.StatusInternalServerError
// 		response.Errors = append(response.Errors, mdlShared.NewResponseError(shared.ErrorInsertingRecord, "LoadLookup", err.Error()))
