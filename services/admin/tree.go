...
// func CreateTree(r *http.Request) *mdlShared.Response {
// 	tree := models.Tree{}
...
// func LoadAllTrees(r *http.Request) *mdlShared.Response {
// 	trees := []models.Tree{}
...
// func LoadTree(r *http.Request) *mdlShared.Response {
// 	tree := models.Tree{}
...
// func UpdateTree(r *http.Request) *mdlShared.Response {
// 	treeID := chi.URLParam(r, "tree_id")
// 	treeIDColumn := fmt.Sprintf("%s.id", shared.TableCoreTrees)
// 	condition := builder.Equal(treeIDColumn, treeID)
// 	tree := models.Tree{
...
// func DeleteTree(r *http.Request) *mdlShared.Response {
// 	treeID := chi.URLParam(r, "tree_id")
// 	treeIDColumn := fmt.Sprintf("%s.id", shared.TableCoreTrees)
// 	condition := builder.Equal(treeIDColumn, treeID)
...
// func CreateTreeLevel(r *http.Request) *mdlShared.Response {
// 	treeID := chi.URLParam(r, "tree_id")
...
// func LoadAllTreeLevels(r *http.Request) *mdlShared.Response {
...
// func LoadTreeLevel(r *http.Request) *mdlShared.Response {
// 	treeLevel := models.TreeLevel{}
...
// func UpdateTreeLevel(r *http.Request) *mdlShared.Response {
// 	treeLevelID := chi.URLParam(r, "tree_level_id")
// 	treeLevelIDColumn := fmt.Sprintf("%s.id", shared.TableCoreTreeLevels)
// 	condition := builder.Equal(treeLevelIDColumn, treeLevelID)
// 	treeLevel := models.TreeLevel{
...
// func DeleteTreeLevel(r *http.Request) *mdlShared.Response {
// 	treeLevelID := chi.URLParam(r, "tree_level_id")
// 	treeLevelIDColumn := fmt.Sprintf("%s.id", shared.TableCoreTreeLevels)
// 	condition := builder.Equal(treeLevelIDColumn, treeLevelID)
...
// func CreateTreeUnit(r *http.Request) *mdlShared.Response {
// 	treeID := chi.URLParam(r, "tree_id")
...
// func LoadAllTreeUnits(r *http.Request) *mdlShared.Response {
...
// func LoadTreeUnit(r *http.Request) *mdlShared.Response {
// 	treeUnit := models.TreeUnit{}
...
// func UpdateTreeUnit(r *http.Request) *mdlShared.Response {
// 	treeUnitID := chi.URLParam(r, "tree_unit_id")
// 	treeUnitIDColumn := fmt.Sprintf("%s.id", shared.TableCoreTreeUnits)
// 	condition := builder.Equal(treeUnitIDColumn, treeUnitID)
// 	treeUnit := models.TreeUnit{
...
// func DeleteTreeUnit(r *http.Request) *mdlShared.Response {
// 	treeUnitID := chi.URLParam(r, "tree_unit_id")
// 	treeUnitIDColumn := fmt.Sprintf("%s.id", shared.TableCoreTreeUnits)
// 	condition := builder.Equal(treeUnitIDColumn, treeUnitID)
...
// // LoadAllTreeUnitPermissions return all instances from the object
// func LoadAllTreeUnitPermissions(r *http.Request) *mdlShared.Response {
// 	permissions := []models.Permission{}

// 	treeUnitID := chi.URLParam(r, "tree_unit_id")
// 	treeUnitIDColumn := fmt.Sprintf("%s.parent_id", shared.ViewCoreStructurePermissions)
...
// 		builder.Equal(treeUnitIDColumn, treeUnitID),
// 		builder.Equal(languageCodeColumn, languageCode),
// 	)

// 	return db.Load(r, &permissions, "LoadAllTreeUnitPermissions", shared.ViewCoreStructurePermissions, condition)
// }

// // InsertTreeUnitPermission persists the request body creating a new object in the database
// func InsertTreeUnitPermission(r *http.Request) *mdlShared.Response {
// 	treeUnitID := chi.URLParam(r, "tree_unit_id")
...
// func RemoveTreeUnitPermission(r *http.Request) *mdlShared.Response {
...
// 		response.Errors = append(response.Errors, mdlShared.NewResponseError(shared.ErrorParsingRequest, "RemovePermissionFromGroup", err.Error()))
