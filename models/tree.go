...
type Tree struct {
	...
	CreatedByUser *models.User `json:"created_by_user" table:"core_users" alias:"created_by_user" on:"created_by_user.id = core_trees.created_by"`
	CreatedAt     time.Time    `json:"created_at" sql:"created_at"`
	UpdatedBy     string       `json:"updated_by" sql:"updated_by"`
	UpdatedByUser *models.User `json:"updated_by_user" table:"core_users" alias:"updated_by_user" on:"updated_by_user.id = core_trees.updated_by"`
...
type TreeLevel struct {
	...
	CreatedBy     string       `json:"created_by" sql:"created_by"`
	CreatedByUser *models.User `json:"created_by_user" table:"core_users" alias:"created_by_user" on:"created_by_user.id = core_tree_levels.created_by"`
	CreatedAt     time.Time    `json:"created_at" sql:"created_at"`
	UpdatedBy     string       `json:"updated_by" sql:"updated_by"`
	UpdatedByUser *models.User `json:"updated_by_user" table:"core_users" alias:"updated_by_user" on:"updated_by_user.id = core_tree_levels.updated_by"`
	UpdatedAt     time.Time    `json:"updated_at" sql:"updated_at"`
}
...
type TreeUnit struct {
	...
	Active        bool         `json:"active" sql:"active"`
	CreatedBy     string       `json:"created_by" sql:"created_by"`
	CreatedByUser *models.User `json:"created_by_user" table:"core_users" alias:"created_by_user" on:"created_by_user.id = core_tree_units.created_by"`
	CreatedAt     time.Time    `json:"created_at" sql:"created_at"`
	UpdatedBy     string       `json:"updated_by" sql:"updated_by"`
	UpdatedByUser *models.User `json:"updated_by_user" table:"core_users" alias:"updated_by_user" on:"updated_by_user.id = core_tree_units.updated_by"`
	UpdatedAt     time.Time    `json:"updated_at" sql:"updated_at"`
}
