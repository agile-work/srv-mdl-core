...
func SchemaRoutes() *chi.Mux {
	...
	r.Route("/", func(r chi.Router) {
		...
		r.Post("/{schema_id}/pages/{page_id}/containers/{container_id}/types/{type}/structures", controller.PostContainerStructure)
		r.Get("/{schema_id}/pages/{page_id}/containers/{container_id}/types/{type}/structures", controller.GetAllContainerStructures)
		r.Get("/{schema_id}/pages/{page_id}/containers/{container_id}/types/{type}/structures/{container_structure_id}", controller.GetContainerStructure)
		r.Patch("/{schema_id}/pages/{page_id}/containers/{container_id}/types/{type}/structures/{container_structure_id}", controller.UpdateContainerStructure)
		r.Delete("/{schema_id}/pages/{page_id}/containers/{container_id}/types/{type}/structures/{container_structure_id}", controller.DeleteContainerStructure)
